...
function clearData() {
    ...
    promptDiv.innerHTML = `
        <div style="position: fixed; top: 50%; left: 50%; transform: translate(-50%, -50%);
            ...
            <p>wipe all saved features in development version? continuing will wipe saved settings, pinned games and downloaded content.</p> 
            <p>this cannot be undone unless you have exported your data previously.</p>
            <p>this data is ONLY being cleared from development mode. do you want to continue? </p>
